...
export class ActualizaMovInmobiliarioDto {
    ...
    static crear(objeto: { [key: string]: any }): [string?, ActualizaMovInmobiliarioDto?] {
    // static crear(objeto: { [key: string]: any }, uso:string): [string?, AgregarComisionistaDto?] {
        ...
        return [ undefined, new ActualizaMovInmobiliarioDto (
            Id_Mov_Inmo,
            Id_ICPC,
            Id_CuentaB,
            Tipo_Movimiento,
