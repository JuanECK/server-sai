...
export class ActualizaMovComisionesDto {
    ...
    static crear(objeto: { [key: string]: any }): [string?, ActualizaMovComisionesDto?] {
    // static crear(objeto: { [key: string]: any }, uso:string): [string?, AgregarComisionistaDto?] {
        ...
        return [ undefined, new ActualizaMovComisionesDto (
            Id_Mov_Com,
            Id_ModeloNegocio,
            Id_ICPC,
            Id_CuentaB,
