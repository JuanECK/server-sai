...
export class MovDivisasServicio {
    ...
    public async getDataInicio() {
        try {
            ...
            array.push(listaCliente[0],listaConcepto[0],listaDivisasYued[0],listaCuentasDivisas[0],listaCuentasYued[0],listaidsYued[0],listaYuedPesos[0],listaYuedDolar[0])
    ...
    public async setActualizaMovDivisas( actualizaMovDivisasDto: ActualizaMovDivisasDto) {
        ...
        try {
         ...
         const {  Id_Mov_Div,Id_ICPC,Concepto,Id_CuentaB,Tipo_Movimiento,Monto,Comision,Tipo_Cuenta,Observaciones,usuario,estatus, 
           
            } = actualizaMovDivisasDto

            const sql = 'sp_actualiza_movDivisa :Id_Mov_Div,:Id_ICPC,:Concepto,:Id_CuentaB,:Tipo_Movimiento,:Monto,:Comision,:Tipo_Cuenta,:Observaciones,:usuario,:estatus'
    ...
    public async agregaMovDivisas( agregarMovDivisasDto: AgregarMovDivisasDto) {
        ...
        try {
            ...
            console.log({Datos:agregarMovDivisasDto})
             ...
             const {    Id_ICPC, Concepto, Id_CuentaB, Tipo_Movimiento, Monto, Comision, Tipo_Cuenta, Observaciones, usuario, 
            } = agregarMovDivisasDto

            const sql = 'sp_inserta_movDivisa  :Id_ICPC, :Concepto, :Id_CuentaB, :Tipo_Movimiento, :Monto, :Comision, :Tipo_Cuenta, :Observaciones, :usuario'
